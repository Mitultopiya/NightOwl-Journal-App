...
export default function JournalEntryPage() {
  ...
  // Load collections, entry or draft
  useEffect(() => {
    fetchCollections();
    if (editId) {
      setIsEditMode(true);
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <form onSubmit={onSubmit} className="space-y-2 mx-auto">
        ...
        {isLoading && (
          <BarLoader className="mb-4" width={"100%"} color="#1976D2" />
        )}
          ...
          <Controller
            ...
            render={({ field }) => (
              <Select onValueChange={field.onChange} value={field.value}>
                <SelectTrigger
                  className={`${
                    errors.mood ? "border-red-500" : "border-blue-300"
          ...
          <Controller
            ...
            render={({ field }) => (
              <Select
                ...
                value={field.value}
              >
                <SelectTrigger className="border-blue-300 focus:border-blue-600 focus:ring-2 focus:ring-blue-200">
                ...
                <SelectContent>
                  ...
                  <SelectItem value="new">
                    <span className="text-blue-600">+ Create New Collection</span>
                  </SelectItem>
                </SelectContent>
              </Select>
            )}
      ...
      <CollectionForm
        loading={createCollectionLoading}
        onSuccess={(data) => createCollectionFn(data)}
